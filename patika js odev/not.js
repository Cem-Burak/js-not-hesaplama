...
index.classList.add("text-primary")
    if (examGrade >= 90) {
        ...
        textInfo = `${sad} FF =`
        index.classList.add("text-danger")
        index.classList.remove("text-primary")
    }
   
  
}

else {textInfo = "Bilgiler Doğru Değil !!!"}
let info = document.querySelector("#index")
info.classList.add()
